        ...
        <div class="col-lg-6">
          <form onsubmit="return validasi()" action="simpan/bbb.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="nama_bahan" name="nama_bahan" type="text" placeholder="Nama Bahan">
            </div>

            <div class="form-group">
              <label>QTY</label>
              <input class="form-control" id="qty" name="qty" type="number" placeholder="QTY">
            </div>

            <div class="form-group">
              <label>Harga Satuan</label>
              <input class="form-control" id="harga_satuan" name="harga_satuan" type="number" placeholder="Harga Satuan">
            </div>
