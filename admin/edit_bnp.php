<?php include "header.php"; ?>
      ...
      <?php
        $kb = $_GET['kd_bnp'];
        $sql = "select * from bnp where kd_bnp = '$kb'";
        ...
        <div class="col-lg-6">
          <form onsubmit="return validasi()" action="simpan/bnp.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input class="form-control" name="kd_bnp" type="text" value="<?php echo $kb;?>" hidden="true">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="nama_bnp" name="nama_bnp" type="text" value="<?php echo $nb;?>">
            </div>
            ...
            <a href="daftar_bnp.php" class="btn btn-primary">Batal</a>
          </form>
        </div>
      </div>
