<?php include "header.php"; ?>
        ...
        <li class="breadcrumb-item active">Biaya Overheaad Pabrik</li>
      </ol>
      <h2>Input Biaya Overhead Pabrik</h2>
      <hr>
        ...
        <div class="col-lg-6">
          <form onsubmit="return validasi()" action="simpan/bop.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="nama_bop" name="nama_bop" type="text" placeholder="Nama Overhead Pabrik">
            </div>
